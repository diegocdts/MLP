...
def sequential_layers(io_units, hidden_units, is_nonlinear = True):
...
class MLP(nn.Module):
    ...
    def __init__(self, io_units, hidden_units, is_nonlinear):
        super().__init__()
        self.layers = nn.Sequential(*sequential_layers(io_units, hidden_units, is_nonlinear))
